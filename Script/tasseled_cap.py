...
"""
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        sensor_idx = self.parameterAsEnum(
            parameters, self.SENSOR_TYPE, context)
        ...
        for nombre, arr in [("Brightness", Brightness),
                            ("Greenness", Greenness), ("Wetness", Wetness)]:
            if 'feedback' in locals() and feedback.isCanceled():
                break
